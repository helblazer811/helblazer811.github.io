...
`,kj=Rt({opSnippet:Ij}),Sj={kernelName:ha,backendName:"webgl",kernelFunc:kj};const Nj=n=>{const{inputs:t,backend:e,attrs:s}=n,{x:r}=t,{blockShape:o,paddings:i}=s;S(r.shape.length<=4,()=>"spaceToBatchND for rank > 4 with a WebGL backend not implemented yet");const a=o.reduce((x,b)=>x*b),l=[[0,0]];l.push(...i);for(let x=1+o.length;x<r.shape.length;++x)l.push([0,0]);const c=[],u=oC({inputs:{x:r},backend:e,attrs:{paddings:l,constantValue:0}}),h=Ia(u.shape,o,a,!1),d=ka(h.length,o.length,!1),f=Sa(u.shape,o,a,!1),p=et({inputs:{x:u},backend:e,attrs:{shape:h}}),m=Me({inputs:{x:p},backend:e,attrs:{perm:d}}),g=et({inputs:{x:m},backend:e,attrs:{shape:f}});return c.push(u),c.push(p),c.push(m),c.forEach(x=>e.disposeIntermediateTensorInfo(x)),g},Tj={kernelName:ou,backendName:"webgl",kernelFunc:Nj};function Ej(n){const{inputs:t,backend:e}=n,{indices:s,values:r,denseShape:o,defaultValue:i}=t;if(o.shape.length!==1)throw new Error(`Dense shape must be a vector, saw:
  ...
  `,o=new ts(s.shape,r);return e.runWebGLProgram(o,[s],s.dtype)}const Zj={kernelName:ba,backendName:"webgl",kernelFunc:Yj};class Jj{constructor(t,e,s){this.variableNames=["x"],this.outputShape=s;const r=s.length,o=Wt(s.length),i=Wt(s.length);let a="";if(r===1)a="coords * strides + begin";else{let l=0;a=s.map((c,u)=>(l++,s.length===1?`coords * strides[${u}] + begin[${u}]`:`coords[${l-1}] * strides[${u}] + begin[${u}]`)).join(",")}this.userCode=`
    ...
    `}}function Qj(n){const{inputs:t,backend:e,attrs:s}=n,{x:r}=t,{begin:o,end:i,strides:a,beginMask:l,endMask:c,ellipsisMask:u,newAxisMask:h,shrinkAxisMask:d}=s,{finalShapeSparse:f,finalShape:p,isIdentity:m,sliceDim0:g,isSimpleSlice:x,begin:b,end:w,strides:y}=Xf(r.shape,o,i,a,l,c,u,h,d);let v;if(m)v=et({inputs:{x:r},backend:e,attrs:{shape:p}});else if(g||x){S(r.shape.length>=1,()=>`Input must have rank at least 1, got: ${r.shape.length}`);const N=Hf(b,w,y),T=Lo({inputs:{x:r},backend:e,attrs:{begin:b,size:N}});v=et({inputs:{x:T},backend:e,attrs:{shape:p}}),e.disposeIntermediateTensorInfo(T)}else if(e.shouldExecuteOnCPU([r])){const T=e.readSync(r.dataId),I=$t(r.shape,r.dtype,T),k=xV(f,I,y,b);v=e.makeTensorInfo(p,r.dtype,k.values)}else{const T=new Jj(b,y,f);v=e.runWebGLProgram(T,[r],r.dtype)}const $=et({inputs:{x:v},backend:e,attrs:{shape:p}});return e.disposeIntermediateTensorInfo(v),$}const t5={kernelName:sf,backendName:"webgl",kernelFunc:Qj};function e5(n){const{inputs:t,backend:e,attrs:s}=n,{separator:r,nGramWidths:o,leftPad:i,rightPad:a,padWidth:l,preserveShortSequences:c}=s,{data:u,dataSplits:h}=t,d=e.readSync(u.dataId),f=e.readSync(h.dataId),[p,m]=bV(d,f,r,o,i,a,l,c);return[e.makeTensorInfo([p.length],"string",p),e.makeTensorInfo(h.shape,"int32",m)]}const n5={kernelName:Zx,backendName:"webgl",kernelFunc:e5};function s5(n){const{inputs:t,backend:e,attrs:s}=n,{skipEmpty:r}=s,{input:o,delimiter:i}=t;if(o.dtype!=="string")throw new Error("Input must be of datatype string");if(o.shape.length!==1)throw new Error(`Input must be a vector, got shape: ${o.shape}`);if(i.shape.length!==0)throw new Error(`Delimiter must be a scalar, got shape: ${i.shape}`);const a=e.readSync(o.dataId),l=e.readSync(i.dataId)[0],[c,u,h]=yV(a,l,r),d=u.length;return[e.makeTensorInfo([d,2],"int32",c),e.makeTensorInfo([d],"string",u),e.makeTensorInfo([2],"int32",new Int32Array(h))]}const r5={kernelName:Jx,backendName:"webgl",kernelFunc:s5};function o5(n){const{inputs:t,backend:e,attrs:s}=n,{numBuckets:r}=s,{input:o}=t;if(o.dtype!=="string")throw new Error("Input must be of datatype string");if(r<=0)throw new Error("Number of buckets must be at least 1");const i=e.readSync(o.dataId),a=wV(i,r);return e.makeTensorInfo(o.shape,"int32",a)}const i5={kernelName:Qx,backendName:"webgl",kernelFunc:o5};const a5="return tan(x);",l5=Rt({opSnippet:a5}),c5={kernelName:ma,backendName:"webgl",kernelFunc:l5};const u5=`
  float e2x = exp(-2.0 * abs(x));
  return sign(x) * (1.0 - e2x) / (1.0 + e2x);
`,h5=Rt({opSnippet:u5}),d5={kernelName:ga,backendName:"webgl",kernelFunc:h5};function f5(n){const{inputs:t,backend:e,attrs:s}=n,{tensor:r,indices:o,updates:i}=t,{sliceRank:a,numUpdates:l,sliceSize:c,strides:u,outputSize:h}=Lr(i,o,r.shape),d=[h/c,c];if(h===0)return e.makeTensorInfo(r.shape,o.dtype);const f=et({inputs:{x:o},backend:e,attrs:{shape:[l,a]}}),p=et({inputs:{x:i},backend:e,attrs:{shape:[l,c]}}),m=et({inputs:{x:r},backend:e,attrs:{shape:d}}),g=new Qp(l,a,f.shape.length,p.shape.length,u,d,!1,!0),x=e.runWebGLProgram(g,[p,f,m],m.dtype),b=et({inputs:{x},backend:e,attrs:{shape:r.shape}});return e.disposeIntermediateTensorInfo(f),e.disposeIntermediateTensorInfo(p),e.disposeIntermediateTensorInfo(m),e.disposeIntermediateTensorInfo(x),b}const p5={kernelName:Gx,backendName:"webgl",kernelFunc:f5};class m5{constructor(t,e){this.variableNames=["A"];const s=new Array(t.length);for(let i=0;i<s.length;i++)s[i]=t[i]*e[i];this.outputShape=s,this.rank=s.length;const r=Wt(this.rank),o=g5(t);this.userCode=`
      void main() {
        ${r} resRC = getOutputCoords();
        setOutput(getA(${o}));
      }
    `}}function g5(n){const t=n.length;if(t>5)throw Error(`Tile for rank ${t} is not yet supported`);if(t===1)return`imod(resRC, ${n[0]})`;const e=["resRC.x","resRC.y","resRC.z","resRC.w","resRC.u"],s=[];for(let r=0;r<n.length;r++)s.push(`imod(${e[r]}, ${n[r]})`);return s.join()}function aC(n){const{inputs:t,backend:e,attrs:s}=n,{x:r}=t,{reps:o}=s;if(r.dtype==="string"||r.shape.length>5){const l=e.readSync(r.dataId),c=r.dtype==="string"?l.map(d=>zs(d)):l,u=$t(r.shape,r.dtype,c),h=CV(u,o);return e.makeTensorInfo(h.shape,h.dtype,h.values)}const i=new m5(r.shape,o);return e.runWebGLProgram(i,[r],r.dtype)}const x5={kernelName:xa,backendName:"webgl",kernelFunc:aC};class b5{constructor(t){this.variableNames=["x","indices"],this.customUniforms=[{name:"n",type:"int"},{name:"firstPass",type:"int"},{name:"negativeInf",type:"float"},{name:"dir",type:"int"},{name:"inc",type:"int"}],this.outputShape=t,this.userCode=`
       void main() {
         ivec2 coords = getOutputCoords();
         int batch = coords[0];
     ...
     `}}class y5{constructor(t){this.variableNames=["x","indices"],this.customUniforms=[{name:"n",type:"int"},{name:"firstPass",type:"int"},{name:"k",type:"int"}],this.outputShape=t,this.userCode=`
    void main() {
     ...
     `}}function sr(n,t){t!==null&&n.disposeIntermediateTensorInfo(t)}function tx(n){let t=1;for(;t<n;)t*=2;return t}function w5(n){const{inputs:t,backend:e,attrs:s}=n,{x:r}=t,{k:o,sorted:i}=s,a=W().getNumber("TOPK_LAST_DIM_CPU_HANDOFF_SIZE_THRESHOLD"),l=W().getNumber("TOPK_K_CPU_HANDOFF_THRESHOLD"),c=r.shape,u=c[c.length-1];if(e.shouldExecuteOnCPU([r])||u<a||o>l){const k=e.readSync(r.dataId),[C,R]=$V(k,c,r.dtype,o,i);return[e.makeTensorInfo(C.shape,C.dtype,C.values),e.makeTensorInfo(R.shape,R.dtype,R.values)]}if(o===0)return c[c.length-1]=0,[e.makeTensorInfo(c,r.dtype,[]),e.makeTensorInfo(c,"int32",[])];if(u===1)return[r,Ba({attrs:{shape:c,dtype:"int32",value:0},backend:e})];const h=e.texData.get(r.dataId),d=h!==null&&h.isPacked,f=d?e.unpackTensor(r):r,m=q(c)/u,g=et({inputs:{x:f},attrs:{shape:[m,u]},backend:e});d&&sr(e,f);const x=tx(o),b=tx(u);let w=null;const y=()=>w===null?[g,g]:[g,w],v=(k,C,R)=>{const D=y(),M=new b5(R),z=[[u],[w===null?1:0],[Number.NEGATIVE_INFINITY],[k],[C]],G=w;w=e.runWebGLProgram(M,D,"int32",z),sr(e,G)};for(let k=1;k<x;k*=2){const C=k*2;for(let R=k;R>=1;R/=2)v(C,R,[m,b])}for(let k=b;k>x;k/=2){const C=y(),R=new y5([m,k/2]),M=[[u],[w===null?1:0],[x]],O=w;w=e.runWebGLProgram(R,C,"int32",M),sr(e,O);const z=x/2,G=z*2;for(let V=z;V>=1;V/=2)v(G,V,w.shape)}let $=w;w=Lo({inputs:{x:w},backend:e,attrs:{begin:0,size:[m,o]}}),sr(e,$);let N=Qv({inputs:{x:g,indices:w},backend:e,attrs:{axis:1,batchDims:1}});sr(e,g);const T=c.slice(0,-1);T.push(o),$=w,w=et({inputs:{x:w},attrs:{shape:T},backend:e}),sr(e,$);const I=N;return N=et({inputs:{x:N},attrs:{shape:T},backend:e}),sr(e,I),[N,w]}const v5={kernelName:rf,backendName:"webgl",kernelFunc:w5};class C5{constructor(t,e,s,r,o,i){this.variableNames=["Image","Transforms"],this.outputShape=i;const a=s==="nearest"?1:2;let l;switch(r){case"constant":l=1;break;case"reflect":l=2;break;case"wrap":l=3;break;case"nearest":l=4;break;default:l=1;break}this.userCode=`
        ...
        `}}function $5(n){const{inputs:t,backend:e,attrs:s}=n,{image:r,transforms:o}=t,{interpolation:i,fillMode:a,fillValue:l,outputShape:c}=s,[u,h,d,f]=r.shape,[p,m]=c??[h,d],g=[u,p,m,f],x=new C5(h,d,i,a,l,g);return e.runWebGLProgram(x,[r,o],"float32")}const I5={kernelName:of,backendName:"webgl",kernelFunc:$5};function k5(n){const{inputs:t,attrs:e,backend:s}=n,{axis:r}=e,{x:o}=t;La(o,"unique"),console.warn("WARNING: ","UI might be locked temporarily as data is being downloaded");const i=s.readSync(o.dataId),{outputValues:a,outputShape:l,indices:c}=IV(i,r,o.shape,o.dtype);return[s.makeTensorInfo(l,o.dtype,a),s.makeTensorInfo([c.length],"int32",c)]}const S5={kernelName:af,backendName:"webgl",kernelFunc:k5};function N5(n){const{inputs:t,backend:e,attrs:s}=n,{value:r}=t;let{axis:o}=s;o<0&&(o+=r.shape.length);const i=r,a=i.shape.length,l=r.shape[o],c=new Array(a-1);let u=0;for(let m=0;m<a;m++)m!==o&&(c[u++]=i.shape[m]);const h=[],d=new Array(a).fill(0),f=i.shape.slice();f[o]=1;const p=new Array(l);for(let m=0;m<p.length;m++){d[o]=m;const g=Lo({inputs:{x:i},backend:e,attrs:{begin:d,size:f}}),x=et({inputs:{x:g},backend:e,attrs:{shape:c}});p[m]=x,h.push(g)}return h.forEach(m=>e.disposeIntermediateTensorInfo(m)),p}const T5={kernelName:lu,backendName:"webgl",kernelFunc:N5};class E5{constructor(t,e){this.variableNames=["x","segmentIds"];const s=t.windowSize,r=t.batchSize,o=t.inSize,i=t.numSegments,a=i*Math.ceil(o/s);this.outputShape=[r,a];const l="0.0",c="sumValue",u=Math.floor(s/4)*4,h=s%4,d=`
