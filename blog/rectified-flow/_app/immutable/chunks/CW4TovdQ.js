import{e as ft,d as We,a as ne,f as Se,s as ze}from"./QRJNuNGS.js";import{i as pt}from"./BXyzJnSu.js";import{f as gt,u as mt,p as yt,Q as vt,n as l,m as G,R as q,l as j,M as X,T as bt,D as Ve,i as Pt,U as ge,k as le,t as ce,j as qe,v as Le}from"./WAWlr0V5.js";import{p as m,a as St,i as He,s as Tt,b as wt}from"./B5wFzeb_.js";import{a as he,T as kt}from"./BTQNMVSA.js";import{b as Ne}from"./B4ZR9csn.js";import{s as L,D as _t,f as Ze,h as Ct}from"./CdVvK9B8.js";function Qe(n,e,t){gt(()=>{var i=mt(()=>e(n,t?.())||{});if(i?.destroy)return()=>i.destroy()})}function Ye(n){if(n.startsWith("#")){const t=n.slice(1);return t.length===3?[parseInt(t[0]+t[0],16)/255,parseInt(t[1]+t[1],16)/255,parseInt(t[2]+t[2],16)/255]:[parseInt(t.slice(0,2),16)/255,parseInt(t.slice(2,4),16)/255,parseInt(t.slice(4,6),16)/255]}const e=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);return e?[parseInt(e[1])/255,parseInt(e[2])/255,parseInt(e[3])/255]:(console.warn(`[parseColor] Could not parse color: ${n}, defaulting to white`),[1,1,1])}function xt(n,e,t){const i=n.length;if(i===0)return{segments:new Float32Array(0),segmentCount:0,trajectoryCount:0,maxTimeIndex:0,headPositions:new Float32Array(0)};let s=0;for(const c of n){const h=Math.min(e+1,c.length-1);h>s&&(s=h)}let r=0;for(const c of n){const h=Math.min(e+1,c.length-1);r+=h}const u=[],a=new Float32Array(i*4);for(let c=0;c<i;c++){const h=n[c],o=Math.min(e+1,h.length-1),P=At(h,o,t.opacityGradient);for(let d=0;d<o;d++){const k=(d+c*1e-4)/Math.max(s,1);u.push([h[d][0],h[d][1],h[d+1][0],h[d+1][1],P[d],P[d+1],k,0])}const p=o,g=(p+c*1e-4)/Math.max(s,1);a[c*4+0]=h[p][0],a[c*4+1]=h[p][1],a[c*4+2]=g,a[c*4+3]=P[p]}u.sort((c,h)=>c[6]-h[6]);const f=new Float32Array(r*8);for(let c=0;c<u.length;c++){const h=u[c],o=c*8;f[o+0]=h[0],f[o+1]=h[1],f[o+2]=h[2],f[o+3]=h[3],f[o+4]=h[4],f[o+5]=h[5],f[o+6]=h[6],f[o+7]=h[7]}return{segments:f,segmentCount:r,trajectoryCount:i,maxTimeIndex:s,headPositions:a}}function At(n,e,t){const i=new Array(e+1);if(!t||t.mode==="none")for(let s=0;s<=e;s++)i[s]=1;else if(t.mode==="recency"){const s=t.timeWindow??.8,r=Math.max(1,Math.floor(s*n.length)),u=Math.max(0,e-r);for(let a=0;a<=e;a++)a<u?i[a]=0:i[a]=(a-u)/Math.max(e-u,1)}else if(t.mode==="custom"&&t.perSegmentAlphas){const s=t.perSegmentAlphas;for(let r=0;r<=e;r++)i[r]=s[0]?.[r]??1}else for(let s=0;s<=e;s++)i[s]=1;return i}const It=`/**
...
`,me=2.5,ye=.8,Ot="#3b82f6",Bt=64;class Te{constructor(e,t,i,s,r,u,a,f){this.segmentBuffer=null,this.headBuffer=null,this.bindGroup=null,this.headBindGroup=null,this.depthTexture=null,this.segmentCount=0,this.headCount=0,this.thickness=me,this.colorR=.231,this.colorG=.51,this.colorB=.965,this.baseOpacity=ye,this.outlineThickness=me+2,this.outlineColorR=0,this.outlineColorG=0,this.outlineColorB=0,this.outlineOpacity=ye,this.hasOutline=!1,this.device=e,this.context=t,this.format=i,this.pipeline=s,this.uniformBuffer=r,this.canvasWidth=u,this.canvasHeight=a,this.dpr=f,this.createDepthTexture()}static async create(e,t={}){const i=t.dpr??(typeof window<"u"?window.devicePixelRatio:1)??1;if(!navigator.gpu)throw new Error("WebGPU is not supported in this browser");const s=await navigator.gpu.requestAdapter();if(!s)throw new Error("Failed to get WebGPU adapter");const r=await s.requestDevice(),u=e.getContext("webgpu");if(!u)throw new Error("Failed to get WebGPU canvas context");const a=navigator.gpu.getPreferredCanvasFormat();u.configure({device:r,format:a,alphaMode:"premultiplied"});const f=r.createShaderModule({label:"Trajectory Shader",code:It}),c=r.createBuffer({label:"Trajectory Uniforms",size:Bt,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),h=r.createBindGroupLayout({label:"Trajectory Bind Group Layout",entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.VERTEX,buffer:{type:"read-only-storage"}}]}),o=r.createPipelineLayout({label:"Trajectory Pipeline Layout",bindGroupLayouts:[h]}),P=r.createRenderPipeline({label:"Trajectory Render Pipeline",layout:o,vertex:{module:f,entryPoint:"vs_main"},fragment:{module:f,entryPoint:"fs_main",targets:[{format:a,blend:{color:{srcFactor:"one",dstFactor:"one",operation:"max"},alpha:{srcFactor:"one",dstFactor:"one",operation:"max"}}}]},depthStencil:{format:"depth24plus",depthWriteEnabled:!0,depthCompare:"less"},primitive:{topology:"triangle-list"}});return new Te(r,u,a,P,c,e.width,e.height,i)}createDepthTexture(){this.depthTexture&&this.depthTexture.destroy(),this.depthTexture=this.device.createTexture({label:"Trajectory Depth Texture",size:[this.canvasWidth,this.canvasHeight],format:"depth24plus",usage:GPUTextureUsage.RENDER_ATTACHMENT})}setTrajectories(e,t,i){this.thickness=i.strokeWidth??me;const s=Ye(i.color??Ot);if(this.colorR=s[0],this.colorG=s[1],this.colorB=s[2],this.baseOpacity=i.opacity??ye,this.hasOutline=!!i.outline,i.outline){const u=Ye(i.outline.color??"#000000"),a=i.outline.strokeWidth??2;this.outlineThickness=this.thickness+a,this.outlineColorR=u[0],this.outlineColorG=u[1],this.outlineColorB=u[2],this.outlineOpacity=i.outline.opacity??this.baseOpacity}const r=xt(e,t,i);if(this.segmentCount=r.segmentCount,this.headCount=r.trajectoryCount,this.segmentCount===0){this.segmentBuffer=null,this.headBuffer=null,this.bindGroup=null,this.headBindGroup=null;return}this.segmentBuffer&&this.segmentBuffer.destroy(),this.headBuffer&&this.headBuffer.destroy(),this.segmentBuffer=this.device.createBuffer({label:"Trajectory Segments",size:r.segments.byteLength,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),this.device.queue.writeBuffer(this.segmentBuffer,0,r.segments.buffer),this.headBuffer=this.device.createBuffer({label:"Trajectory Heads",size:r.headPositions.byteLength,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),this.device.queue.writeBuffer(this.headBuffer,0,r.headPositions.buffer),this.bindGroup=this.device.createBindGroup({label:"Trajectory Bind Group",layout:this.pipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.uniformBuffer}},{binding:1,resource:{buffer:this.segmentBuffer}}]}),this.headBindGroup=this.device.createBindGroup({label:"Trajectory Head Bind Group",layout:this.pipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.uniformBuffer}},{binding:1,resource:{buffer:this.headBuffer}}]})}draw(e,t,i,s){this.setTrajectories(e,t,i),this.render(s)}render(e){if(!this.bindGroup||this.segmentCount===0||!this.depthTexture){if(e){const f=this.device.createCommandEncoder(),c=this.context.getCurrentTexture().createView();f.beginRenderPass({colorAttachments:[{view:c,clearValue:{r:e[0],g:e[1],b:e[2],a:e[3]},loadOp:"clear",storeOp:"store"}]}).end(),this.device.queue.submit([f.finish()])}return}const t=this.device.createCommandEncoder(),i=this.context.getCurrentTexture().createView(),s=this.depthTexture.createView(),r=e?"clear":"load",u=e?{r:e[0],g:e[1],b:e[2],a:e[3]}:{r:0,g:0,b:0,a:0},a=t.beginRenderPass({colorAttachments:[{view:i,clearValue:u,loadOp:r,storeOp:"store"}],depthStencilAttachment:{view:s,depthClearValue:1,depthLoadOp:r,depthStoreOp:"store"}});this.hasOutline&&(this.updateUniforms(!0),a.setPipeline(this.pipeline),a.setBindGroup(0,this.bindGroup),a.draw(6,this.segmentCount,0,0)),this.updateUniforms(!1),a.setPipeline(this.pipeline),a.setBindGroup(0,this.bindGroup),a.draw(6,this.segmentCount,0,0),a.end(),this.device.queue.submit([t.finish()])}updateUniforms(e){const t=new Float32Array(16);t[0]=this.canvasWidth,t[1]=this.canvasHeight,t[2]=this.dpr,t[3]=0,t[4]=this.thickness,t[5]=this.colorR,t[6]=this.colorG,t[7]=this.colorB,t[8]=this.baseOpacity,t[9]=this.outlineThickness,t[10]=this.outlineColorR,t[11]=this.outlineColorG,t[12]=this.outlineColorB,t[13]=this.outlineOpacity,t[14]=e?1:0,t[15]=0,this.device.queue.writeBuffer(this.uniformBuffer,0,t)}resize(e,t,i){this.canvasWidth=e,this.canvasHeight=t,i!==void 0&&(this.dpr=i),this.createDepthTexture()}get backend(){return"gpu"}destroy(){this.uniformBuffer.destroy(),this.segmentBuffer&&this.segmentBuffer.destroy(),this.headBuffer&&this.headBuffer.destroy(),this.depthTexture&&this.depthTexture.destroy()}}function Xt(n,e,t,i,s){n.beginPath(),n.moveTo(e,t),n.lineTo(i,s),n.stroke()}function Mt(n,e,t,i,s,r){let a=Math.atan2(s-t,i-e);n.beginPath(),n.moveTo(i+r*Math.cos(a),s+r*Math.sin(a)),a+=2*Math.PI/3,n.lineTo(i+r*Math.cos(a),s+r*Math.sin(a)),a+=2*Math.PI/3,n.lineTo(i+r*Math.cos(a),s+r*Math.sin(a)),n.closePath(),n.fill()}function Jt(n,e,t,i,s,r){const u=Math.atan2(s-t,i-e);n.beginPath(),n.moveTo(e,t),n.lineTo(i,s),n.stroke();let a=u;n.beginPath(),n.moveTo(i+r*Math.cos(a),s+r*Math.sin(a)),a+=2*Math.PI/3,n.lineTo(i+r*Math.cos(a),s+r*Math.sin(a)),a+=2*Math.PI/3,n.lineTo(i+r*Math.cos(a),s+r*Math.sin(a)),n.closePath(),n.fill()}function ve(n,e,t,i){if(t==null||isNaN(t))throw new Error(`drawTrajectories: segmentIndex is invalid (${t})`);const s=e.length;if(s===0)return;n.lineCap="round",n.lineJoin="round";const r=i.outline,u=r?.strokeWidth??2,a=i.strokeWidth+u,f=r?.color??"#000000",c=r?.opacity??i.opacity;for(let h=0;h<s;h++){const o=e[h];if(!o||o.length===0)continue;if(i.showPreview){if(r){n.lineWidth=a,n.strokeStyle=f,n.globalAlpha=(i.previewOpacity??.15)*(c/i.opacity),n.beginPath();for(let p=0;p<o.length;p++){const[g,d]=o[p];p===0?n.moveTo(g,d):n.lineTo(g,d)}n.stroke()}n.lineWidth=i.strokeWidth,n.strokeStyle=i.color,n.globalAlpha=i.previewOpacity??.15,n.beginPath();for(let p=0;p<o.length;p++){const[g,d]=o[p];p===0?n.moveTo(g,d):n.lineTo(g,d)}n.stroke()}const P=i.perSegmentAlphas?.[h];if(P){const p=i.gradientSubdivisions??1;for(let g=0;g<o.length-1;g++){const d=P[g]??0,k=P[g+1]??0;if(d<=0&&k<=0)continue;const[b,y]=o[g],[x,B]=o[g+1];for(let E=0;E<p;E++){const D=E/p,H=(E+1)/p,N=d+(k-d)*((E+.5)/p);if(N<=0)continue;const Z=b+(x-b)*D,J=y+(B-y)*D,K=b+(x-b)*H,ie=y+(B-y)*H;r&&(n.lineWidth=a,n.strokeStyle=f,n.globalAlpha=N*(c/i.opacity),n.beginPath(),n.moveTo(Z,J),n.lineTo(K,ie),n.stroke()),n.lineWidth=i.strokeWidth,n.strokeStyle=i.color,n.globalAlpha=N,n.beginPath(),n.moveTo(Z,J),n.lineTo(K,ie),n.stroke()}}}else{const p=Math.floor(t),g=t-p,d=Math.min(p+1,o.length-1);let k,b;if(g>0&&d+1<o.length){const[y,x]=o[d],[B,E]=o[d+1];k=y+g*(B-y),b=x+g*(E-x)}else[k,b]=o[d];if(r){n.lineWidth=a,n.strokeStyle=f,n.globalAlpha=c,n.beginPath();for(let y=0;y<=d&&y<o.length;y++){const[x,B]=o[y];y===0?n.moveTo(x,B):n.lineTo(x,B)}g>0&&d+1<o.length&&n.lineTo(k,b),n.stroke()}n.lineWidth=i.strokeWidth,n.strokeStyle=i.color,n.globalAlpha=i.opacity,n.beginPath();for(let y=0;y<=d&&y<o.length;y++){const[x,B]=o[y];y===0?n.moveTo(x,B):n.lineTo(x,B)}g>0&&d+1<o.length&&n.lineTo(k,b),n.stroke()}if(i.showHeadMarker!==!1){const p=Math.floor(t),g=t-p,d=Math.min(p+1,o.length-1);let k,b,y,x;if(g>0&&d+1<o.length){const[D,H]=o[d],[N,Z]=o[d+1];k=D+g*(N-D),b=H+g*(Z-H),y=D,x=H}else{[k,b]=o[d];const D=Math.max(0,d-1);[y,x]=o[D]}const B=i.headStyle?.type??"circle",E=i.headStyle?.radius??i.pointRadius;r&&B==="circle"&&(n.beginPath(),n.arc(k,b,i.pointRadius+(a-i.strokeWidth)/2,0,2*Math.PI),n.fillStyle=f,n.globalAlpha=c,n.fill()),n.fillStyle=i.headStyle?.color??i.color,n.globalAlpha=i.headStyle?.opacity??i.opacity,B==="arrow"?Mt(n,y,x,k,b,E):(n.beginPath(),n.arc(k,b,E,0,2*Math.PI),n.fill())}}n.globalAlpha=1}const Pe=new WeakMap,be=new WeakMap,Xe=new WeakSet;async function Rt(n){const e=Pe.get(n);if(e)return e;const t=be.get(n);if(t)return t;const i=(async()=>{try{const s=typeof window<"u"?window.devicePixelRatio:1,r=await Te.create(n,{dpr:s});return Pe.set(n,r),r}catch(s){return console.warn("[drawTrajectories] GPU unavailable, falling back to CPU:",s),null}finally{be.delete(n)}})();return be.set(n,i),i}function Et(n){return n.opacityGradient?n:n.perSegmentAlphas?{...n,opacityGradient:{mode:"custom",perSegmentAlphas:n.perSegmentAlphas}}:n}async function Gt(n,e,t,i,s){const r=Et(i);if(n instanceof HTMLCanvasElement){const a=n,f=[0,0,0,0];if(Xe.has(a)){const o=a.getContext("2d");o&&(o.clearRect(0,0,a.width,a.height),ve(o,e,t,r));return}const c=Pe.get(a);if(c){c.draw(e,t,r,f);return}const h=await Rt(a);if(!h){Xe.add(a);const o=a.getContext("2d");o&&(o.clearRect(0,0,a.width,a.height),ve(o,e,t,r));return}h.draw(e,t,r,f)}else ve(n,e,t,r)}function Je(n,e){let t=null,i=null;function s(a=n,f=e){if(!t)return;const c=window.devicePixelRatio||1;t.width=a*c,t.height=f*c,i=t.getContext("2d"),i&&i.setTransform(c,0,0,c,0,0)}function r(a){return t=a,s(),{destroy(){t=null,i=null}}}function u(a){t=a,s()}return{bindCanvas:r,init:u,resize:s,get canvas(){return t},get ctx(){return i}}}class jt{constructor(){this.duration=1,this.looping=!1,this.endPauseDuration=0,this._initialState=null,this._time=0,this._isPlaying=!1,this._isSeeking=!1,this._cachedState=null,this.clips=[],this.nextClipId=0,this.clock=new Dt,this.tickCallbacks=new Set,this.endPauseRemaining=0}get initialState(){if(this._initialState===null)throw new Error("Timeline.initialState must be set before use");return this._initialState}set initialState(e){this._initialState=e,this._cachedState=null}get time(){return this._time}get isPlaying(){return this._isPlaying}get isSeeking(){return this._isSeeking}get state(){return this._cachedState===null&&(this._cachedState=this.resolveState()),this._cachedState}add(e,t,i={}){const s=i.id??`clip-${this.nextClipId++}`;return this.clips.push({clip:e,start:t.start,end:t.end,options:{layer:i.layer??0,ephemeral:i.ephemeral??!1,id:s},playCount:0}),this._cachedState=null,s}remove(e){const t=this.clips.findIndex(i=>i.options.id===e);return t!==-1?(this.clips.splice(t,1),this._cachedState=null,!0):!1}clearLayer(e){this.clips=this.clips.filter(t=>t.options.layer!==e),this._cachedState=null}setState(e,t,i={}){const s=this._time/this.duration;return this.add({name:e,reduce:()=>t},{start:s,end:s},i)}playClip(e,t,i={}){const s=this._time/this.duration;return this.add(e,{start:s,end:s+t},{...i,ephemeral:!0})}setEndPause(e){this.endPauseDuration=e}play(){this._isPlaying||(this._isPlaying=!0,this.clock.start(e=>this.tick(e)))}pause(){this._isPlaying&&(this._isPlaying=!1,this.clock.stop())}startSeeking(){this._isSeeking=!0}endSeeking(){this._isSeeking=!1}seek(e){this._time=Math.max(0,Math.min(e*this.duration,this.duration)),this.endPauseRemaining=0,this._cachedState=null,this.tickCallbacks.forEach(t=>t(this._time/this.duration,this.state))}reset(){this._time=0,this.endPauseRemaining=0,this._cachedState=null}dispose(){this.pause(),this.tickCallbacks.clear(),this.clips=[],this._cachedState=null}resetState(){this._time=0,this.endPauseRemaining=0,this._cachedState=null,this.clips.forEach(e=>e.playCount=0)}replaceClips(e){this.clips=[],this._cachedState=null,e.forEach(({clip:t,timing:i,options:s})=>this.add(t,i,s))}onTick(e){return this.tickCallbacks.add(e),()=>{this.tickCallbacks.delete(e)}}get isAtEnd(){return this._time>=this.duration}tick(e){if(this._isSeeking){this.tickCallbacks.forEach(t=>t(this._time/this.duration,this.state));return}if(this.endPauseRemaining>0){this.endPauseRemaining-=e,this.endPauseRemaining<=0&&this.looping&&(this._time=0,this._cachedState=null),this.tickCallbacks.forEach(t=>t(this._time/this.duration,this.state));return}this._time=Math.min(this._time+e,this.duration),this._cachedState=null,this.isAtEnd&&(this.endPauseDuration>0&&this.looping?this.endPauseRemaining=this.endPauseDuration:this.looping?(this._time=0,this.cleanupEphemeralClips()):this.pause()),this.tickCallbacks.forEach(t=>t(this._time/this.duration,this.state))}resolveState(){let t={...this.initialState};const i=new Map;for(const r of this.clips){const{clip:u,start:a,end:f,options:c}=r,h=f-a,o=h===0,P=this._time/this.duration;if(!(o?Math.abs(P-a)<1e-4:P>=a))continue;const g=P>f;(o||g?1:Math.min(1,Math.max(0,(P-a)/h)))>=1&&c.ephemeral&&r.playCount++,i.has(c.layer)||i.set(c.layer,[]),i.get(c.layer).push(r)}const s=Array.from(i.keys()).sort((r,u)=>r-u);for(const r of s){const u=i.get(r);let a={};for(const f of u){const{clip:c,start:h,end:o}=f,P=o-h,p=P===0,g=this._time/this.duration,d=g>o,k=p||d?1:Math.min(1,Math.max(0,(g-h)/P)),b=c.reduce(k,t);b!==null&&(a={...a,...b})}t={...t,...a}}return t}cleanupEphemeralClips(){this.clips=this.clips.filter(e=>!e.options.ephemeral||e.playCount===0)}}class Dt{constructor(){this.rafId=null,this.lastTime=null}start(e){const t=i=>{this.lastTime===null&&(this.lastTime=i);const s=(i-this.lastTime)/1e3;this.lastTime=i,e(s),this.rafId=requestAnimationFrame(t)};this.rafId=requestAnimationFrame(t)}stop(){this.rafId!==null&&(cancelAnimationFrame(this.rafId),this.rafId=null),this.lastTime=null}get isRunning(){return this.rafId!==null}}function Ft(){return{name:"Pause",reduce:()=>null}}function Ut(n){const e={wasPlayingBeforeHidden:!1};function t(i){const s=n();s&&(!i&&s.isPlaying?(e.wasPlayingBeforeHidden=!0,s.pause()):i&&e.wasPlayingBeforeHidden&&(e.wasPlayingBeforeHidden=!1,s.play()))}return{state:e,handleVisibilityChange:t}}class ue{constructor(e,t={}){this.ctx=null,this._initialized=!1;const i=e.length>0?Math.max(...e.map(s=>(s?.length??1)-1),1):1;this.data={pathlines:e,numSegments:i},this.style=t.style??{},this.clip={name:"pathline-animation",reduce:s=>({segmentIndex:Math.floor(s*i)})}}async init(e){const t=e.getContext("2d");if(!t)throw new Error("Failed to get 2D rendering context");this.ctx=t,this._initialized=!0}get initialized(){return this._initialized}draw(e,t){if(!this.ctx){console.warn("PathlineAnimation.draw() called before init()");return}const i=e.pathlines??this.data.pathlines;if(i.length===0)return;const s={strokeWidth:this.style.strokeWidth??2,color:this.style.color??"#3b82f6",opacity:this.style.opacity??.8,pointRadius:this.style.pointRadius??4,...this.style,...t,perSegmentAlphas:e.perSegmentAlphas};Gt(this.ctx,i,e.segmentIndex,s)}destroy(){this.ctx=null,this._initialized=!1}static fromTrajectories(e,t={}){return new ue(e,t)}}var Wt=Se('<div class="panel-container svelte-ipvq8u"><div class="panel-label svelte-ipvq8u"> </div> <canvas class="panel-canvas svelte-ipvq8u" style="cursor: pointer;"></canvas></div>'),zt=Se('<div class="panel-container svelte-ipvq8u"><div class="panel-label svelte-ipvq8u"> </div> <canvas class="panel-canvas svelte-ipvq8u" style="cursor: pointer;"></canvas></div>'),Vt=Se(`<div class="placeholder svelte-ipvq8u"><p>Rectified flow superimposed visualization requires rectified flow data
      with at least 2 steps.</p></div>`);function Kt(n,e){yt(e,!1);const t=()=>St(l(te),"$figureIsActive",i),[i,s]=Tt(),r=G(),u=G(),a=G(),f=G(),c=G(),h=G(),o=G();let P=m(e,"flowMatchingClient",8,null),p=m(e,"rectifiedFlowClient",8,null),g=m(e,"leftTrajectories",24,()=>[]),d=m(e,"rightTrajectories",24,()=>[]),k=m(e,"targetDistribution",24,()=>[]),b=m(e,"canvasWidth",8,400),y=m(e,"canvasHeight",8,400),x=m(e,"marginWidth",8,10),B=m(e,"marginHeight",8,10),E=m(e,"gap",8,20),D=m(e,"domainRange",24,()=>({xMin:-1.7,xMax:1.7,yMin:-1.7,yMax:1.7})),H=m(e,"leftLabel",8,"Flow Matching"),N=m(e,"rightLabel",8,"Rectified Flow"),Z=m(e,"labelFontSize",8,26),J=m(e,"labelColor",24,()=>L.stylingSettings.label.color),K=m(e,"labelOpacity",24,()=>L.stylingSettings.label.opacity),ie=m(e,"targetColor",8,"#3b82f6"),Ke=m(e,"targetOpacity",8,.35),$e=m(e,"targetPointRadius",8,5),we=m(e,"trajectoryColor",24,()=>L.stylingSettings.trajectory.color),et=m(e,"trajectoryStrokeWidth",24,()=>L.stylingSettings.trajectory.strokeWidth);m(e,"trajectoryPointRadius",24,()=>L.stylingSettings.trajectory.endpointRadius);let ke=m(e,"trajectoryOpacity",24,()=>L.stylingSettings.trajectory.opacity);m(e,"trajectoryFullOpacity",24,()=>L.stylingSettings.trajectory.fullOpacity),m(e,"showTrajectoryPreview",8,!1),m(e,"alphaTimeWindow",8,.8);let _e=m(e,"endpointRadius",24,()=>L.stylingSettings.trajectory.endpointRadius),se=m(e,"animationDuration",8,1e4),Ce=m(e,"timing",24,()=>({pauseStart:.8})),xe=m(e,"playingByDefault",8,!0),Ae=m(e,"maxUserTrajectories",24,()=>L.interactiveSettings.maxUserTrajectories),tt=m(e,"onInitialized",8,void 0),nt=m(e,"backgroundVisible",8,!0),it=m(e,"showTimeSlider",8,!0),Ie=m(e,"children",8,void 0),W=G(null),z=G(null);const de=Je(b(),y()),fe=Je(b(),y());let F,U,A=G(null),$=null,ae=null,ee=G(!1),Oe=[],Be=[],Me=[],V=[],re=[],oe=[],Re=!1,pe=0,Q=null,Y=null,te=G();const{handleVisibilityChange:st}=Ut(()=>l(A));function at(){if(!l(u))return;const{xMin:v,xMax:_,yMin:R,yMax:I}=D();F=Ze().domain([v,_]).range([x(),b()-x()]),U=Ze().domain([R,I]).range([B(),y()-B()])}function Ee(v){if(!F||!U||!v||v.length===0)return[];const _=v[0]?.length||0;return Array.from({length:_},(R,I)=>v.map(S=>[F(S[I][0]),U(S[I][1])]))}function rt(){!F||!U||(Oe=k().map(v=>[F(v[0]),U(v[1])]),Be=Ee(g()),Me=Ee(d()))}function ot(){!l(W)||!l(z)||!l(u)||(at(),rt(),De({time:0,segmentIndex:0}),j(ee,!0),tt()?.())}async function lt(){const v={color:we(),strokeWidth:et(),pointRadius:_e(),opacity:ke()};$=ue.fromTrajectories(Be,{style:v}),ae=ue.fromTrajectories(Me,{style:v}),await Promise.all([$.init(l(W)),ae.init(l(z))]),j(A,new jt),ge(A,l(A).initialState={segmentIndex:0}),l(A).add($.clip,{start:0,end:Ce().pauseStart}),l(A).add(Ft(),{start:Ce().pauseStart,end:1}),ge(A,l(A).duration=se()/1e3),ge(A,l(A).looping=!0),l(A).onTick((_,R)=>{R.segmentIndex,De(R)})}function Ge(){l(A)&&l(A).play()}function je(v,_,R,I,S){if(!v||!_||!R)return;_.clearRect(0,0,b(),y()),Ct(_,Oe,$e(),ie(),Ke());const T=Re?.15:ke();if(R.draw(I,{opacity:T}),S.length>0){const C=S.filter(w=>w&&w.length>=2);if(C.length>0){const w=C[0].length-1,O=Math.min(I.segmentIndex,w-1);R.draw({...I,segmentIndex:O,pathlines:C},{opacity:1})}for(const w of S)if(w&&w.length===1){const[O,M]=w[0];_.globalAlpha=1,_.beginPath(),_.arc(O,M,_e(),0,Math.PI*2),_.fillStyle=we(),_.fill()}}}function De(v){!l(u)||!l(h)||!l(o)||!$||!ae||(je(de.canvas,l(h),$,v,re),je(fe.canvas,l(o),ae,v,oe))}function Fe(v,_){if(!P()||!p())return;const I=(_==="left"?l(W):l(z)).getBoundingClientRect(),S=b()/I.width,T=y()/I.height,C=(v.clientX-I.left)*S,w=(v.clientY-I.top)*T,O=F.invert(C),M=U.invert(w);ct([O,M])}function ct(v){if(!P()||!p())return;Q&&(P().stopRequest(Q),Q=null),Y&&(p().stopRequest(Y),Y=null),V=[...V,v],V.length>Ae()&&(V=V.slice(-Ae())),Re=!0,pe=0,re=V.map(S=>[[F(S[0]),U(S[1])]]),oe=V.map(S=>[[F(S[0]),U(S[1])]]),l(A)&&l(A).reset(),Ge();function _(){pe++,pe>=2&&(Q=null,Y=null)}const R=P().sampleFromInitialPoints(V,l(a),{},(S,T)=>{re=re.map((C,w)=>[...C,[F(T[w][0]),U(T[w][1])]])});Q=R.requestId,R.promise.then(_);const I=p().sampleFromInitialPoints(V,l(a),{},(S,T)=>{oe=oe.map((C,w)=>[...C,[F(T[w][0]),U(T[w][1])]])});Y=I.requestId,I.promise.then(_)}vt(()=>{l(A)&&l(A).pause(),Q&&P()&&P().stopRequest(Q),Y&&p()&&p().stopRequest(Y)}),q(()=>X(Ie()),()=>{j(r,Ie())}),q(()=>(X(g()),X(d()),X(k())),()=>{j(u,g()?.length>0&&d()?.length>0&&k()?.length>0)}),q(()=>(l(u),X(g())),()=>{j(a,l(u)?g().length:1)}),q(()=>l(a),()=>{j(f,l(a)-1)}),q(()=>(l(f),X(se())),()=>{j(c,l(f)>0?se()/l(f):se())}),q(()=>l(W),()=>{j(h,l(W)&&de.ctx)}),q(()=>l(z),()=>{j(o,l(z)&&fe.ctx)}),q(()=>(l(u),l(W),l(z),l(ee),X(xe())),()=>{l(u)&&l(W)&&l(z)&&!l(ee)&&(ot(),lt().then(()=>{xe()&&Ge()}))}),q(()=>(l(te),l(ee),t()),()=>{l(te)!==void 0&&l(ee)&&st(t())}),bt(),pt();var Ue=We(),ht=Ve(Ue);{var ut=v=>{_t(v,{get gap(){return E()},get caption(){return l(r)},get backgroundVisible(){return nt()},get isActive(){return l(te)},set isActive(S){wt(j(te,S),"$figureIsActive",i)},left:S=>{var T=Wt(),C=le(T),w=le(C,!0);ce(C);var O=qe(C,2);O.__click=M=>Fe(M,"left"),Ne(O,M=>j(W,M),()=>l(W)),Qe(O,M=>de.bindCanvas?.(M)),ce(T),Le(()=>{he(T,`max-width: ${b()??""}px;`),he(C,`font-size: ${Z()??""}px; color: ${J()??""}; opacity: ${K()??""};`),ze(w,H())}),ne(S,T)},right:S=>{var T=zt(),C=le(T),w=le(C,!0);ce(C);var O=qe(C,2);O.__click=M=>Fe(M,"right"),Ne(O,M=>j(z,M),()=>l(z)),Qe(O,M=>fe.bindCanvas?.(M)),ce(T),Le(()=>{he(T,`max-width: ${b()??""}px;`),he(C,`font-size: ${Z()??""}px; color: ${J()??""}; opacity: ${K()??""};`),ze(w,N())}),ne(S,T)},footer:S=>{var T=We(),C=Ve(T);{var w=O=>{kt(O,{get timeline(){return l(A)},color:"#f17720"})};He(C,O=>{it()&&O(w)})}ne(S,T)},$$slots:{left:!0,right:!0,footer:!0},$$legacy:!0})},dt=v=>{var _=Vt();ne(v,_)};He(ht,v=>{l(u)?v(ut):v(dt,!1)})}ne(n,Ue),Pt(),s()}ft(["click"]);export{ue as P,Kt as R,jt as T,Xt as a,Ut as b,Qe as c,Jt as d,Gt as e,Ft as f,Je as u};
