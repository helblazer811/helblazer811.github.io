...
`}function h3(n,t){const e=n.shapeInfo.logicalShape,s=n.name,o="get"+s.charAt(0).toUpperCase()+s.slice(1),r=n.shapeInfo.texShape,i=[Math.ceil(r[0]/2),Math.ceil(r[1]/2)];if(e[0]===1){const d=e.slice(1),p=[1,2],f=Qo(n,d),m=["b","row","col"];return`
  ...
  `}function x3(n,t){const e=n.name,s=e.charAt(0).toUpperCase()+e.slice(1),o="get"+s+"AtOutCoords",r=n.shapeInfo.logicalShape.length,i=t.logicalShape.length,a=vy(n.shapeInfo.logicalShape,t.logicalShape),l=_t(i),c=i-r;let u;const h=["x","y","z","w","u","v"];r===0?u="":i<2&&a.length>=1?u="coords = 0;":u=a.map(b=>`coords.${h[b+c]} = 0;`).join(`
`);let d="";i<2&&r>0?d="coords":d=n.shapeInfo.logicalShape.map((b,w)=>`coords.${h[w+c]}`).join(", ");let p="return outputValue;";const m=H(n.shapeInfo.logicalShape)===1,x=H(t.logicalShape)===1;if(r===1&&!m&&!x)p=`
  ...
  `}function b3(n,t){const e=n.name,s=e.charAt(0).toUpperCase()+e.slice(1),o="get"+s+"AtOutCoords",r=t.texShape,i=n.shapeInfo.texShape,a=n.shapeInfo.logicalShape.length,l=t.logicalShape.length;if(!n.shapeInfo.isUniform&&a===l&&n.shapeInfo.flatOffset==null&&Et(i,r))return`
    ...
    `;const c=_t(l),u=vy(n.shapeInfo.logicalShape,t.logicalShape),h=l-a;let d;const p=["x","y","z","w","u","v"];a===0?d="":l<2&&u.length>=1?d="coords = 0;":d=u.map(m=>`coords.${p[m+h]} = 0;`).join(`
...
`,RB=St({opSnippet:EB}),AB={kernelName:Ar,backendName:"webgl",kernelFunc:RB};const DB=hn+`
  if (x < 1.0) return NAN;
return log(x + sqrt(x * x - 1.0));`,FB=St({opSnippet:DB}),_B={kernelName:Dr,backendName:"webgl",kernelFunc:FB};const fm="return a + b;",OB=we({opSnippet:fm,packedOpSnippet:fm,supportsComplex:!0,cpuKernelImpl:H3}),MB={kernelName:Go,backendName:"webgl",kernelFunc:OB};class LB{constructor(t,e){this.outputShape=[],this.outputShape=t,this.variableNames=e.map((r,i)=>`T${i}`);const s=[];this.variableNames.forEach(r=>{s.push(`float v${r} = get${r}AtOutCoords();`)});const o=this.variableNames.map(r=>`v${r}`).join(" + ");this.userCode=`
      void main() {
        ${s.join(`
        `)}
...
`,nw=St({opSnippet:v4,packedOpSnippet:k4,cpuKernelImpl:J3,dtype:"float32"}),S4={kernelName:jr,backendName:"webgl",kernelFunc:nw};function Pu(n){const{inputs:t,attrs:e,backend:s}=n,{dim:o}=e,{input:r}=t,i=r.shape.length,a=r.shape.slice();let l=o;return o<0&&(k(-(i+1)<=o,()=>`Axis must be in the interval [${-(i+1)}, ${i}]`),l=i+o+1),a.splice(l,0,1),et({inputs:{x:r},backend:s,attrs:{shape:a}})}const N4={kernelName:gl,backendName:"webgl",kernelFunc:Pu};const wm="return exp(x) - 1.0;",T4=St({opSnippet:wm,packedOpSnippet:wm,cpuKernelImpl:Q3}),E4={kernelName:qr,backendName:"webgl",kernelFunc:T4};class Cm{constructor(t,e,s){this.variableNames=["real","imag"];const o=e[1];this.outputShape=e;const r=s?`2.0 * ${Math.PI}`:`-2.0 * ${Math.PI}`,i=s?`${o}.0`:"1.0";let a;if(t==="real")a="return real * expR - imag * expI;";else if(t==="imag")a="return real * expI + imag * expR;";else throw new Error(`FFT component must be either "real" or "imag", got ${t}.`);this.userCode=`
    ...
    `}}const O4={kernelName:fh,backendName:"webgl",kernelFunc:({inputs:n,backend:t})=>{const{image:e}=n,s=t,o=new _4(e.shape);return s.runWebGLProgram(o,[e],e.dtype)}};const $m="return floor(x);",M4=St({opSnippet:$m,packedOpSnippet:$m,cpuKernelImpl:tz}),L4={kernelName:Kr,backendName:"webgl",kernelFunc:M4};const P4=`
...
`,DU=`
  ...
  return result;
`,FU=St({opSnippet:AU,packedOpSnippet:DU,cpuKernelImpl:lz}),_U={kernelName:ei,backendName:"webgl",kernelFunc:FU};const OU=nr+`
  return log(1.0 + x);
